 ...
 * @author Admin
 */
public class GD_CTCongThuc extends javax.swing.JFrame {

    /**
     * Creates new form GD_CTCongThuc
     */
    public GD_CTCongThuc() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GD_CTCongThuc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GD_CTCongThuc().setVisible(true);
            }
        });
    }
